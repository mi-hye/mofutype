...
MBTI와 생년월일·출생시각으로 로컬 十二支·오행 프로필을 만들고, 최대 30명이 한 그룹에서 관계 그래프를 공유하는 Next.js 앱입니다. 프로필 계산에는 외부 사주 API를 사용하지 않습니다. 관계 리포트는 Eximbay의 PayPay·카드 결제와 연결되는 300엔 단건 상품입니다.
